      ...
      >
        ...
        >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  <div className={cn(
                    ...
                    <CalendarIcon className="w-6 h-6 text-calendar-contrast" />
                  </div>
                  <div>
                    <h2 className={cn(
                      "text-[10px] font-bold uppercase tracking-[0.4em] opacity-40",
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-1">
                    ...
                    <button 
                      ...
                      className={cn(
                        "px-4 py-2 transition-all duration-300 flex flex-col items-center justify-center min-w-[120px] group",
                        isDarkMode ? "text-zinc-100" : "text-zinc-900"
                      )}
                    >
                      <span className={cn(
                        "text-xs font-bold uppercase tracking-[0.3em] leading-none mb-1 transition-colors",
                        "group-hover:text-calendar-primary"
                      )}>
                        {format(currentDate, 'MMMM')}
                      </span>
                      <span className="text-[9px] font-medium opacity-40 tracking-[0.4em] leading-none">
          ...
          <div className="flex flex-col h-full border-l border-zinc-200/50 dark:border-zinc-800">
            ...
            {/* Vertical Action Bar */}
            <div className={cn(
              "p-8 flex flex-col-reverse gap-6 items-end border-t transition-colors duration-500",
              isDarkMode ? "bg-zinc-950 border-zinc-800" : "bg-white border-zinc-200/50",
              !includeNotes && "flex-1 justify-start"
            )}>
              ...
              {!includeNotes && (
                <div className={cn(
                  "text-[9px] font-bold uppercase tracking-[0.5em] rotate-180 [writing-mode:vertical-lr] opacity-20 mb-4 py-4",
                  isDarkMode ? "text-zinc-100" : "text-zinc-900"
                )}>
                  Quick Actions
                </div>
